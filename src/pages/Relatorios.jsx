...
<Card>
<h2 className="text-xl font-semibold text-dark mb-4 bg-white">Frequência de Sessões</h2>
...
<Bar dataKey="sessions" fill="#2493BF" />
            ...
            <Card>
<h2 className="text-xl font-semibold text-dark mb-4 bg-white">Status das Sessões</h2>
<ResponsiveContainer width="100%" height={300}>
<PieChart>
<Pie
                    data={statusData}
...
<Tooltip />
            ...
            <Card>
<h2 className="text-xl font-semibold text-dark mb-4 text-center bg-white">Pacientes por Status de Sessão</h2>
<ResponsiveContainer width="100%" height={300}>
<PieChart>
<Pie
                    data={patientsData}
...
<div className="space-y-3">
              {riskAlerts.length === 0 ? (
<p className="text-dark/70 text-center py-4 bg-white">Nenhum alerta de risco no momento</p>
              ) : (
...
<p className="text-xs text-dark/70 mt-1 bg-white">{new Date(alert.date).toLocaleDateString('pt-BR')}</p>
</div>
</div>
                ))
              )}
